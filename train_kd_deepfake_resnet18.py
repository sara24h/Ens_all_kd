...
def train_student(local_rank, teacher_path, dataset_mode, kd_method='logits',
    ...
    if dataset_mode == '140k':
        ...
        ds = Dataset_selector(dataset_mode='200k', realfake200k_val_csv='/kaggle/input/datasets/sarah20079/undersampled-200k/balanced_unique_200k_dataset/val_labels.csv', realfake200k_test_csv='/kaggle/input/datasets/sarah20079/undersampled-200k/balanced_unique_200k_dataset/test_labels.csv', realfake200k_train_csv='/kaggle/input/datasets/sarah20079/undersampled-200k/balanced_unique_200k_dataset/train_labels.csv', realfake200k_root_dir='/kaggle/input/datasets/sarah20079/undersampled-200k/balanced_unique_200k_dataset', train_batch_size=batch_size, eval_batch_size=64, ddp=True, rank=local_rank, world_size=dist.get_world_size())
